...
$(document).ready(function(){
	...
	$("#delete-submit1").click(function(e){
		...
		if(confirm("삭제하시겠습니까?")){
			let form1 = $("#form1");
			let actionAttr = "${appRoot}/admin/deleteReport";
	...
	const listReply = function(){
		...
		$.ajax({
			url : "${appRoot}/adminReply/reportReplyList",
			type : "get",
			data : data,
	...
	$("#addReplySubmitButton1").click(function(e) {
		...
		console.log(data);
		$.ajax({
			url:"${appRoot }/adminReply/insertReportReply",
			type: "post",
			data: data,
			success: function(data){
				//  새 댓글 등록 메시지 출력
	...
	<div class="container">
		<div class="row">
			<div class="col">
				...
				<form id="form1" action="${appRoot }/admin/updateReport" method="post">
